...
##Pauli matrices
#sigma1 = np.matrix([[0.0,  1.0] , [1.0 ,  0.0]],dtype='complex128')
#sigma2 = np.matrix([[0.0, -1.0j], [1.0j,  0.0]],dtype='complex128')
#sigma3 = np.matrix([[1.0,  0.0] , [0.0 , -1.0]],dtype='complex128')
sigma0 = np.array([[1.0,  0.0] , [0.0 ,  1.0]],dtype='complex128')
sigma1 = np.array([[0.0,  1.0] , [1.0 ,  0.0]],dtype='complex128')
sigma2 = np.array([[0.0, -1.0j], [1.0j,  0.0]],dtype='complex128')
sigma3 = np.array([[1.0,  0.0] , [0.0 , -1.0]],dtype='complex128')
#
aB = Bohr2nm
